...
// ++ Write YOUR CODE Below
 ...
 function makeAcronym(someString){
    let myAcronym = []

    let allInUpperCase = someString.toUpperCase()
    // console.log(allInUpperCase);
    // console.log(typeof allInUpperCase);
    // console.log(allInUpperCase[0]);
      allInUpperCase.split(" ")

      let newArr = allInUpperCase.split(" ")
      // console.log(newArr);


      for(var i = 0; i < newArr.length; i++){
          let arrIteration = newArr[i]

            let onlyFirst = arrIteration.charAt(0)
            // console.log(onlyFirst);

            myAcronym.push(onlyFirst)
      }

        // console.log(myAcronym);
        let finalAcronym = myAcronym.join("")
