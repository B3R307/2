...
// ++ Write YOUR CODE Below
   ...
   function getFirstLetters(someArrOfString){
      onlyFirstChar = []

      for(var i = 0; i < someArrOfString.length; i ++){
           stringFirstChar = someArrOfString[i]


            onlyFirst = stringFirstChar.charAt(0)
            // console.log(onlyFirst);
            // console.log( typeof onlyFirstChar);
              onlyFirstChar.push(onlyFirst)
      }
